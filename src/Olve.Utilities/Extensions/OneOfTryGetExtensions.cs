...
{
    /// <summary>
    /// Gets the value of the <see cref="OneOf{T0, T1}"/> if it is of type <typeparamref name="T0"/>, otherwise returns the default value.
    /// </summary>
    /// <param name="oneOf">The <see cref="OneOf{T0, T1}"/> to get the value from.</param>
    /// <param name="defaultValue">The default value to return if the <see cref="OneOf{T0, T1}"/> is not of type <typeparamref name="T0"/>.</param>
    ...
    /// <summary>
    /// Gets the value of the <see cref="OneOf{T0, T1}"/> if it is of type <typeparamref name="T1"/>, otherwise returns the default value.
    /// </summary>
    /// <param name="oneOf">The <see cref="OneOf{T0, T1}"/> to get the value from.</param>
    /// <param name="defaultValue">The default value to return if the <see cref="OneOf{T0, T1}"/> is not of type <typeparamref name="T1"/>.</param>
    /// <typeparam name="T0">The type of the first value in the <see cref="OneOf{T0, T1}"/>.</typeparam>
    /// <typeparam name="T1">The type of the second value in the <see cref="OneOf{T0, T1}"/>.</typeparam>
    /// <returns></returns>
    ...
    /// <summary>
    /// Gets the value of the <see cref="OneOf{T0, T1, T2}"/> if it is of type <typeparamref name="T0"/>, otherwise returns the default value.
    /// </summary>
    /// <param name="oneOf">The <see cref="OneOf{T0, T1, T2}"/> to get the value from.</param>
    /// <param name="defaultValue">The default value to return if the <see cref="OneOf{T0, T1, T2}"/> is not of type <typeparamref name="T0"/>.</param>
