...
/// <summary>
/// A factory for creating instances of asynchronous operations that implement <see cref="IAsyncOperation{TRequest, TResponse}"/>.
/// </summary>
...
public class AsyncOperationFactory<TOperation, TRequest, TResponse>(IServiceProvider serviceProvider) where TOperation : IAsyncOperation<TRequest, TResponse>
{
    /// <summary>
