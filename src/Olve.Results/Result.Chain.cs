...
public readonly partial struct Result
{
    ...
    /// </returns>
    public static Result<(T1, T2)> Chain<T1, T2>(Func<Result<T1>> a, Func<Result<T2>> b)
    {
        var resultA = a();
    ...
    /// otherwise, the first encountered problem.
    /// </returns>
    public static Result<(T1, T2, T3)> Chain<T1, T2, T3>(Func<Result<T1>> a, Func<Result<T2>> b, Func<Result<T3>> c)
    {
        var resultA = a();
        if (!resultA.Succeeded)
        {
    ...
    /// otherwise, the first encountered problem.
    /// </returns>
    public static Result<(T1, T2, T3, T4)> Chain<T1, T2, T3, T4>(Func<Result<T1>> a, Func<Result<T2>> b, Func<Result<T3>> c, Func<Result<T4>> d)
    {
        var resultA = a();
        if (!resultA.Succeeded)
        {
    ...
    /// <summary>
    /// Chains five result-producing functions, returning a combined result if all succeed.
    /// </summary>
    /// <typeparam name="T1">The type of the first result value.</typeparam>
    /// <typeparam name="T2">The type of the second result value.</typeparam>
    /// <typeparam name="T3">The type of the third result value.</typeparam>
    ...
    /// otherwise, the first encountered problem.
    /// </returns>
    public static Result<(T1, T2, T3, T4, T5)> Chain<T1, T2, T3, T4, T5>(Func<Result<T1>> a, Func<Result<T2>> b, Func<Result<T3>> c, Func<Result<T4>> d, Func<Result<T5>> e)
    {
        var resultA = a();
        if (!resultA.Succeeded)
        {
    ...
    /// <summary>
    /// Chains six result-producing functions, returning a combined result if all succeed.
    /// </summary>
    /// <typeparam name="T1">The type of the first result value.</typeparam>
    /// <typeparam name="T2">The type of the second result value.</typeparam>
    /// <typeparam name="T3">The type of the third result value.</typeparam>
    ...
    /// otherwise, the first encountered problem.
    /// </returns>
    public static Result<(T1, T2, T3, T4, T5, T6)> Chain<T1, T2, T3, T4, T5, T6>(Func<Result<T1>> a, Func<Result<T2>> b, Func<Result<T3>> c, Func<Result<T4>> d, Func<Result<T5>> e, Func<Result<T6>> f)
    {
        var resultA = a();
        if (!resultA.Succeeded)
        {
