...
- **DeletionResultExtensions** – `DiscardResult` for `DeletionResult`. Its `Match`, `MapToResult` (with `allowNotFound`), equality and other members are generated by `[GenerateResult]`.
